              ...
              >
                <Dialog.Panel className="max-h-screen max-w-screen-md transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                  <div className="group relative">
                    ...
                    <div className="overlay absolute bottom-[-5px] flex h-max w-full flex-col rounded-lg px-4 pt-6 text-sky-100 opacity-0 transition-all group-hover:bottom-0 group-hover:opacity-100">
